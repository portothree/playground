// /Users/gustavoporto/www/portothree/playground/zod/node_modules/zod/lib/index.mjs
...
var parseWithNullDefaults = (schema2, data) => {
  const parsedData = {};
  for (const key of Object.keys(schema2.shape)) {
    if (data[key] !== undefined) {
      parsedData[key] = schema2.shape[key].parse(data[key]);
    } else {
      parsedData[key] = null;
    }
  }
  return schema2.parse(parsedData);
};
var inputData = { property1: "Hello" };
var result = parseWithNullDefaults(schema, inputData);
console.log(result);
export {
  parseWithNullDefaults
};
